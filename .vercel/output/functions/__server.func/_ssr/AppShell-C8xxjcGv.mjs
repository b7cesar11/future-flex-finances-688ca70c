...
import { I as CalendarRange, J as CircleUserRound, L as CalendarClock, O as CreditCard, P as Check, R as CalendarCheck, T as LayoutList, V as ArrowLeftRight, b as LogOut, c as TrendingDown, h as PiggyBank, i as Users, k as Contact, n as X, p as Plus, q as House, r as Wallet, s as TrendingUp, v as Package, w as ListChecks, y as Menu } from "../_libs/lucide-react.mjs";
import { t as clsx } from "../_libs/clsx.mjs";
import { t as twMerge } from "../_libs/tailwind-merge.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/AppShell-C8xxjcGv.js
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)("nav", {
			...
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("ul", {
				...
				children: [
					leftItems.map((it) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(NavItem, { ...it }, it.to)),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", {
						...
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
							...
							children: ({ isActive }) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								className: cn("-mt-7 flex h-14 w-14 items-center justify-center rounded-full shadow-glow ring-4 ring-background transition-all", isActive ? "bg-gradient-primary text-primary-foreground scale-105" : "bg-gradient-primary text-primary-foreground hover:scale-105 active:scale-95"),
								children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CalendarCheck, {
									className: "h-6 w-6",
									strokeWidth: 2.2
								})
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								className: cn("text-[10.5px] font-medium mt-1", isActive ? "text-primary" : "text-muted-foreground"),
								children: "Compromissos"
							})] })
						})
					}),
					rightItems.map((it) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(NavItem, { ...it }, it.to))
				]
			})
		}),
