...
import { S as Loader, W as TriangleAlert, Y as CircleCheck, j as Circle, n as X, x as Lock } from "../_libs/lucide-react.mjs";
import { t as ConfirmDialog } from "./ConfirmDialog-UpGu7Zfw.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/ParcelasList-mEhocyNy.js
...
*/
function ParcelasList({ groupId, groupType = "purchase", onClose }) {
	const { transacoes, pessoas, pagarParcela, encerrarParcelamento } = useFinance();
	const parcelas = (0, import_react.useMemo)(() => transacoes.filter((t) => groupType === "commitment" ? t.commitmentGroupId === groupId : t.purchaseGroupId === groupId).sort((a, b) => (a.installmentNumber ?? 0) - (b.installmentNumber ?? 0)), [
		transacoes,
		groupId,
		groupType
	]);
		...
		children: [
					...
					return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", {
						...
						children: [
							...
							pago ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								...
								children: [busy ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Loader, { className: "h-3 w-3 animate-spin" }) : null, busy ? "Marcando" : "Marcar paga"]
							})
						]
					}, t.id);
				})]
			...
			podeAgir && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("footer", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Circle, { className: "h-3.5 w-3.5" }), "Cancelar sem pagamento"]
				})]
			}),
