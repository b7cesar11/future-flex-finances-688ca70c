...
import { i as formatBRLFull, o as useFinance, r as formatBRL } from "./finance-store-DtGAnrm7.mjs";
import { h as Link } from "../_libs/@tanstack/react-router+[...].mjs";
import { D as HandCoins, E as Landmark, M as ChevronRight, O as CreditCard, P as Check, _ as Pencil, d as Snowflake, f as Repeat, l as Trash2, n as X, p as Plus, t as Zap } from "../_libs/lucide-react.mjs";
import { t as AppShell } from "./AppShell-C8xxjcGv.mjs";
import { t as ProgressBar } from "./ProgressBar-CUWzyoRP.mjs";
import { t as ConfirmDialog } from "./ConfirmDialog-UpGu7Zfw.mjs";
import { r as ParcelasList } from "./ParcelasList-mEhocyNy.mjs";
import { t as PayCheckbox } from "./PayCheckbox-BiXeFJkl.mjs";
import { t as OverdueBadge } from "./OverdueBadge-DxIA_cEE.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/minhas-dividas-JbYrJwbU.js
...
function MinhasDividas() {
	const { dividas, contas, pagarParcela, estornarParcela, updateDebtInstallment, deleteDebt, congelarCompromisso, descongelarCompromisso } = useFinance();
										...
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											...
											children: isEditing ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
												...
												children: [
													...
													d.commitmentGroupId && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
														type: "button",
														"aria-label": d.frozenAt ? "Descongelar" : "Congelar",
														onClick: async () => {
															if (d.frozenAt) await descongelarCompromisso(d.commitmentGroupId);
															else await congelarCompromisso(d.commitmentGroupId);
														},
