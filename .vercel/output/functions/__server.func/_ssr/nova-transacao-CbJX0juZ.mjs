...
import { D as CreditCard, L as ArrowLeft, m as Pin, o as UserPlus, q as CircleCheck } from "../_libs/lucide-react.mjs";
import { t as AppShell } from "./AppShell-DX7ldnxD.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/nova-transacao-CbJX0juZ.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
function NovaTransacao() {
	const { kind = "despesa", terceiro: terceiroInitial, direction: dirInitial } = useSearch({ from: "/_authenticated/nova-transacao" });
